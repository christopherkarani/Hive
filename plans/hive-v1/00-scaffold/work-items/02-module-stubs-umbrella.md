...
Task BreakDown:
1. Create Sources layout for HiveCore, HiveCheckpointWax, HiveConduit, Hive (umbrella).
...
4. Add Hive umbrella file that re-exports HiveCore, HiveConduit, HiveCheckpointWax.
